...
class Mysoea_steadyGA_templet(ea.SoeaAlgorithm):
	"""
...
"""
	...
	def run(self):
		...
		while self.terminated(population) == False:
			...
			# print("chooseIdx:",type(chooseIdx),chooseIdx.shape,chooseIdx[0:5])
			# print("population.ObjV:", type(population.ObjV), population.ObjV.shape, population.ObjV[0:5])
